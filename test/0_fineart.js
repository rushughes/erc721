...
contract('FineArt', function(accounts) {
  ...
  it("...should add an NFT in the second account", function() {
    return FineArt.deployed().then(function(instance) {
      ...
      return fineArtInstance.createFineArt(accounts[1], 2, '/ipfs/QmcD15114nUG9abaFAXJ4ERo2rNMJ5B8NXJqkc3Qt6pyru', {from: accounts[0]});
    }).then(function() {
  ...
  it("...the second account should own the NFT", function() {
    return FineArt.deployed().then(function(instance) {
      ...
      return fineArtInstance.ownerOf(2);
    }).then(function(account) {
  ...
  it("...the first account can send their NFT to the second account", function() {
    return FineArt.deployed().then(function(instance) {
      ...
      return fineArtInstance.transfer(accounts[1], 1, {from: accounts[0]});
    }).then(function() {
      return fineArtInstance.ownerOf(1);
    }).then(function(account) {
      assert.equal(account, accounts[1], "The NFT is not owned by the second account.");
  ...
  it("...the first account can NOT steal the second accounts NFT", function() {
    return FineArt.deployed().then(function(instance) {
      ...
      return fineArtInstance.transfer(accounts[0], 2, {from: accounts[0]});
    }).then(function() {
      return fineArtInstance.ownerOf(2);
    }).then(function(account) {
  ...
  it("...the second account can NOT create NFTs", function() {
    return FineArt.deployed().then(function(instance) {
      ...
      return fineArtInstance.createFineArt(accounts[1], 3, '/ipfs/QmfTd2R8LJPZwvzf4cM69xjHw9eC2H2BdaA3kHMg6Aq1Vq', {from: accounts[1]});
    }).then(function() {
